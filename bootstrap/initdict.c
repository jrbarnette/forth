...
/* 405 */ { .handler = i_addname }, { .id = "BIN" }, { .handler = x_bin },
/* 408 */ { .handler = i_addname }, { .id = "CLOSE-FILE" }, { .handler = x_close_file },
/* 411 */ { .handler = i_addname }, { .id = "CREATE-FILE" }, { .handler = x_create_file },
/* 414 */ { .handler = i_addname }, { .id = "FILE-POSITION" }, { .handler = x_file_position },
/* 417 */ { .handler = i_addname }, { .id = "FILE-SIZE" }, { .handler = x_file_size },
/* 420 */ { .handler = i_addname }, { .id = "OPEN-FILE" }, { .handler = x_open_file },
/* 423 */ { .handler = i_addname }, { .id = "R/O" }, { .handler = x_r_o },
/* 426 */ { .handler = i_addname }, { .id = "R/W" }, { .handler = x_r_w },
/* 429 */ { .handler = i_addname }, { .id = "READ-FILE" }, { .handler = x_read_file },
/* 432 */ { .handler = i_addname }, { .id = "REPOSITION-FILE" }, { .handler = x_reposition_file },
/* 435 */ { .handler = i_addname }, { .id = "W/O" }, { .handler = x_w_o },
/* 438 */ { .handler = i_addname }, { .id = "WRITE-FILE" }, { .handler = x_write_file },
END_DIRECT // }
