...
/* 321 */ { .handler = x_comma },
/* 322 */ { .handler = do_literal }, { .cell = (cell_ft) (&DICT.base) },
/* 324 */ { .handler = do_literal }, { .cell = (cell_ft) (0x0A) },
/* 326 */ { .handler = x_over },
/* 327 */ { .handler = x_store },
/* 328 */ { .handler = i_addname }, { .id = "BASE" }, { .handler = do_constant },
/* 331 */ { .handler = x_comma },
/* 332 */ { .handler = do_literal }, { .cell = (cell_ft) (&DICT.state) },
/* 334 */ { .handler = i_addname }, { .id = "STATE" }, { .handler = do_constant },
/* 337 */ { .handler = x_comma },
/* 338 */ { .handler = i_addname }, { .id = "ABORT" }, { .handler = x_abort },
/* 341 */ { .handler = i_addname }, { .id = "CHAR" }, { .handler = x_char },
/* 344 */ { .handler = i_addname }, { .id = "DECIMAL" }, { .handler = x_decimal },
/* 347 */ { .handler = i_addname }, { .id = "EVALUATE" }, { .handler = x_evaluate },
/* 350 */ { .handler = i_addname }, { .id = "EXECUTE" }, { .handler = x_execute },
/* 353 */ { .handler = i_addname }, { .id = "LITERAL" }, { .handler = x_literal },
/* 356 */ { .handler = i_setflags }, { .cell = (cell_ft) (0xC0) },
/* 358 */ { .handler = i_addname }, { .id = "POSTPONE" }, { .handler = x_postpone },
/* 361 */ { .handler = i_setflags }, { .cell = (cell_ft) (0xC0) },
/* 363 */ { .handler = do_literal }, { .cell = (cell_ft) (do_postpone) },
/* 365 */ { .handler = x_comma },
/* 366 */ { .handler = i_addname }, { .id = "QUIT" }, { .handler = x_quit },
/* 369 */ { .handler = i_addname }, { .id = "SOURCE" }, { .handler = x_source },
