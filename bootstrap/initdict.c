...
/* 488 */ { .handler = i_startname }, { .id = "CELLS" }, { .handler = do_colon },
/* 491 */ { .handler = do_literal }, { .cell = (cell_ft) (CELL_SIZE) },
/* 493 */ { .handler = meta_interpret },
/* 494 */     { .id = "LITERAL" },
/* 495 */     { .id = NULL },
/* 496 */ { .handler = meta_compile },
/* 497 */     { .id = "*" },
/* 498 */     { .id = "EXIT" },
/* 499 */     { .id = NULL },
/* 500 */ { .handler = i_linkname },
/* 501 */ { .handler = i_startname }, { .id = "CELL+" }, { .handler = do_colon },
/* 504 */ { .handler = do_literal }, { .cell = (cell_ft) (0x1) },
/* 506 */ { .handler = meta_interpret },
/* 507 */     { .id = "cells" },
/* 508 */     { .id = "LITERAL" },
/* 509 */     { .id = NULL },
