...
/* 335 */ { .handler = x_store },
/* 336 */ { .handler = i_addname }, { .id = ">IN" }, { .handler = x_to_in },
/* 339 */ { .handler = i_addname }, { .id = "ABORT" }, { .handler = x_abort },
/* 342 */ { .handler = i_addname }, { .id = "BASE" }, { .handler = x_base },
/* 345 */ { .handler = i_addname }, { .id = "CHAR" }, { .handler = x_char },
/* 348 */ { .handler = i_addname }, { .id = "DECIMAL" }, { .handler = x_decimal },
/* 351 */ { .handler = i_addname }, { .id = "EVALUATE" }, { .handler = x_evaluate },
/* 354 */ { .handler = i_addname }, { .id = "EXECUTE" }, { .handler = x_execute },
/* 357 */ { .handler = i_addname }, { .id = "LITERAL" }, { .handler = x_literal },
/* 360 */ { .handler = i_setflags }, { .cell = (cell_ft) (0xC0) },
/* 362 */ { .handler = i_addname }, { .id = "POSTPONE" }, { .handler = x_postpone },
/* 365 */ { .handler = i_setflags }, { .cell = (cell_ft) (0xC0) },
/* 367 */ { .handler = i_addname }, { .id = "QUIT" }, { .handler = x_quit },
/* 370 */ { .handler = i_addname }, { .id = "SOURCE" }, { .handler = x_source },
/* 373 */ { .handler = i_addname }, { .id = "STATE" }, { .handler = x_state },
/* 376 */ { .handler = i_addname }, { .id = "S\"" }, { .handler = x_s_quote },
/* 379 */ { .handler = i_setflags }, { .cell = (cell_ft) (0xC0) },
/* 381 */ { .handler = i_addname }, { .id = "[" }, { .handler = x_left_bracket },
/* 384 */ { .handler = i_setflags }, { .cell = (cell_ft) (0xC0) },
/* 386 */ { .handler = i_addname }, { .id = "]" }, { .handler = x_right_bracket },
/* 389 */ { .handler = i_addname }, { .id = "C\"" }, { .handler = x_c_quote },
/* 392 */ { .handler = i_setflags }, { .cell = (cell_ft) (0xC0) },
/* 394 */ { .handler = i_addname }, { .id = "HEX" }, { .handler = x_hex },
/* 397 */ { .handler = i_addname }, { .id = "PARSE" }, { .handler = x_parse },
/* 400 */ { .handler = i_addname }, { .id = "REFILL" }, { .handler = x_refill },
/* 403 */ { .handler = i_addname }, { .id = "BIN" }, { .handler = x_bin },
/* 406 */ { .handler = i_addname }, { .id = "CLOSE-FILE" }, { .handler = x_close_file },
/* 409 */ { .handler = i_addname }, { .id = "CREATE-FILE" }, { .handler = x_create_file },
/* 412 */ { .handler = i_addname }, { .id = "FILE-POSITION" }, { .handler = x_file_position },
/* 415 */ { .handler = i_addname }, { .id = "FILE-SIZE" }, { .handler = x_file_size },
/* 418 */ { .handler = i_addname }, { .id = "OPEN-FILE" }, { .handler = x_open_file },
/* 421 */ { .handler = i_addname }, { .id = "R/O" }, { .handler = x_r_o },
/* 424 */ { .handler = i_addname }, { .id = "R/W" }, { .handler = x_r_w },
/* 427 */ { .handler = i_addname }, { .id = "READ-FILE" }, { .handler = x_read_file },
/* 430 */ { .handler = i_addname }, { .id = "REPOSITION-FILE" }, { .handler = x_reposition_file },
/* 433 */ { .handler = i_addname }, { .id = "W/O" }, { .handler = x_w_o },
/* 436 */ { .handler = i_addname }, { .id = "WRITE-FILE" }, { .handler = x_write_file },
END_DIRECT // }
